...
export const MESSAGE_RATE_LIMIT: RateLimitOpts = { maxRequests: 10, windowMs: 60_000 }; // 10 messages/min par IP
export const MESSAGE_ACCOUNT_RATE_LIMIT: RateLimitOpts = { maxRequests: 20, windowMs: 60_000 }; // 20 messages/min par compte
